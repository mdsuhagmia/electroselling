...
const BanSlick = () => {
  ...
  return (
    <div className='bg-gray-50 shadow border-b-2 border-gray-200'>
      {cateShow.map((item) => (
        <div className='grid grid-cols-2 gap-x-4 py-12 h-76 lg:h-90'>
          <div>
            <h2 className='md:text-2xl font-bold font-lat text-red-500 pl-30 pt-2'>New Collection 2025</h2>
            <h2 className='text-md lg:text-2xl font-bold font-lat text-[#06051d] pl-30 pt-3 leading-[26px] lg:leading-[32px]'>{item.title}</h2>
